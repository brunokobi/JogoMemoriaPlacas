(function(){
	...
	// carregamento de musica de fundo
	var musica = document.querySelector('#musica');
	musica.preload = "auto";
	musica.load();
	
	var promise = document.querySelector('#musica').play();
	...
	// carregamento do som de acerto
	var certoSom = document.querySelector('#certo');
	certoSom.preload = "auto";
	certoSom.load();
	// carregamento do som de erro
	var erroSom = document.querySelector('#erro');
	erroSom.preload = "auto";
	erroSom.load();	
	// carregamento do som de virar a carta
	var viraSom = document.querySelector('#vira');
	viraSom.preload = "auto";
	viraSom.load();	
	// carregamento do som de vitoria
	var fimSom = document.querySelector('#fim');
	fimSom.preload = "auto";
	fimSom.load();
	...
	//	musica.play();	
		...
		for(var i = 0; i < 16; i++){
			...
			carta.style.left = (i % 8) === 0 ? 5 + "px" : 5 + ((i % 8) * 165) + "px";
			carta.style.top = i/8 >= 1 ? 250 + "px" : 5 + "px";
